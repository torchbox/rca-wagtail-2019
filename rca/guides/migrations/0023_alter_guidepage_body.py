                        ...
                        wagtail.blocks.StructBlock(
                            [
                                (
                                    "first_col_is_header",
                                    wagtail.blocks.BooleanBlock(
                                        help_text="When checked, the first column of each row will be rendered as a <th> instead of a regular <td>, providing richer semantic context to the following columns.",
                                        label="First columns are headers",
                                        required=False,
                                    ),
                                ),
                                (
