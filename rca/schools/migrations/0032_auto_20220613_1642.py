...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='schoolpage',
            name='external_links',
            field=wagtail.fields.StreamField([('link', wagtail.blocks.StructBlock([('url', rca.navigation.models.URLOrRelativeURLBLock(required=False)), ('page', wagtail.blocks.PageChooserBlock(required=False)), ('title', wagtail.blocks.CharBlock(help_text="Leave blank to use the page's own title, required if using a URL", required=False))]))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='schoolpage',
            name='programmes_cta_block',
            field=wagtail.fields.StreamField([('call_to_action', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(help_text='A large heading diplayed at the top of block', required=False)), ('description', wagtail.blocks.CharBlock(required=False)), ('page', wagtail.blocks.PageChooserBlock(required=False)), ('link', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False))], help_text='An optional link to display below the expanded content', required=False))], label='text promo'))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='schoolpage',
            name='programmes_external_links',
            field=wagtail.fields.StreamField([('link', wagtail.blocks.StructBlock([('url', rca.navigation.models.URLOrRelativeURLBLock(required=False)), ('page', wagtail.blocks.PageChooserBlock(required=False)), ('title', wagtail.blocks.CharBlock(help_text="Leave blank to use the page's own title, required if using a URL", required=False))]))], blank=True, use_json_field=True, verbose_name='Links'),
        ),
        migrations.AlterField(
            model_name='schoolpage',
