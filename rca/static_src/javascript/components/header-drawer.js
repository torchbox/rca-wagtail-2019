class HeaderDrawer {
    ...
    constructor(node) {
        ...
        this.desktopSearch = document.querySelector('[data-search-desktop] [data-search-input]');
    ...
    bindEventListeners() {
        ...
        document.addEventListener('click', (e) => {
            if (this.body.classList.contains('nav-open') && e.target.classList.contains('header__menus')) {
