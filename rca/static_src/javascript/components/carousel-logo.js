...
class LogoCarousel {
    ...
    bindEvents() {
        ...
        // Match next/prev button to amount of slides perView
        this.slideshow.on('run.before', (evt) => {
            const scrollSteps = this.slideshow.settings.perView;
