...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='body',
            field=wagtail.fields.StreamField([('quote_block', wagtail.blocks.StructBlock([('quote', wagtail.blocks.CharBlock(form_classname='title', help_text='Enter quote text only, there is no need to add quotation marks')), ('author', wagtail.blocks.CharBlock(required=False)), ('job_title', wagtail.blocks.CharBlock(required=False))])), ('rich_text_block', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'bold', 'italic', 'image', 'ul', 'ol', 'link'])), ('link_block', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False))]))], blank=True, use_json_field=True, verbose_name='Body copy'),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='external_links',
        ...
        migrations.AlterField(
            model_name='projectpage',
            name='funders',
            field=wagtail.fields.StreamField([('link', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False))]))], blank=True, use_json_field=True, verbose_name='Links to funders'),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='gallery',
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField([('accordion_block', wagtail.blocks.StructBlock([('heading', wagtail.blocks.CharBlock(help_text='A large heading diplayed next to the block', required=False)), ('preview_text', wagtail.blocks.CharBlock(help_text='The text to display when the accordion is collapsed', required=False)), ('body', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'bold', 'italic', 'image', 'ul', 'ol', 'link'], help_text='The content shown when the accordion expanded')), ('link', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False))], help_text='An optional link to display below the expanded content', required=False))]))], blank=True, use_json_field=True, verbose_name='More information'),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='partners',
            field=wagtail.fields.StreamField([('link', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False))]))], blank=True, use_json_field=True, verbose_name='Links to partners'),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='quote_carousel',
