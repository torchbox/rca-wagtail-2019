    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Not displayed for small teaser profiles')),
                ...
                ('source_page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='speakers', to='events.eventdetailpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
