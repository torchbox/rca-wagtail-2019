...
# The last 3 characters of your api key
MAILCHIMP_DATA_CENTER = env.get("MAILCHIMP_DATA_CENTER", None)
# Audience ID goes here
MAILCHIMP_EMAIL_LIST_ID = env.get("MAILCHIMP_EMAIL_LIST_ID", None)
